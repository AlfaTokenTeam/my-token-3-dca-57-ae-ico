...
import "./MyToken3DCA57AE.sol";

contract MyToken3DCA57AEPreSale {
    MyToken3DCA57AE public token;
    ...
    function MyToken3DCA57AEPreSale(
        MyToken3DCA57AE _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken3DCA57AE(_token);
